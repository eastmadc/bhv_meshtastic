...
#endif
#if HAS_SENSOR && (!MESHTASTIC_EXCLUDE_ENVIRONMENTAL_SENSOR || !MESHTASTIC_EXCLUDE_HEALTH_TELEMETRY)
#include "main.h"
...
#endif
#if HAS_SENSOR && !MESHTASTIC_EXCLUDE_HEALTH_TELEMETRY
